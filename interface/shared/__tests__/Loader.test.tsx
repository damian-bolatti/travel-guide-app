...
describe('Loader', () => {
  ...
  it('applies correct classNames to wrapper and message', () => {
    ...
    expect(getByTestId('loader-wrapper').props.className).toContain('bg-background');
    expect(getByTestId('loader-message').props.className).toContain('text-icon');
    expect(getByTestId('loader-message').props.className).toContain('text-center');
  });
