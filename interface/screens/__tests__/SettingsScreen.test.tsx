...
describe('SettingsScreen', () => {
  ...
  it('renders correct label, switch state and version', () => {
    ...
    expect(getByTestId('settings-version').props.children).toBe('App Version 0.1.0');
  });
  ...
  it('applies correct classNames', () => {
    ...
    expect(getByTestId('settings-label').props.className).toContain('font-work-medium');
    expect(getByTestId('settings-version').props.className).toContain('text-icon');
  });
});
