...
describe('PlaceCard', () => {
  ...
  it('applies correct Tailwind classes', () => {
    ...
    expect(getByTestId('place-card').props.className).toContain('bg-card-background');
    expect(getByTestId('place-card').props.className).toContain('dark:bg-card-background-dark');
    ...
    expect(getByTestId('place-name').props.className).toContain('font-work-bold');
    expect(getByTestId('place-name').props.className).toContain('text-text-header');
    expect(getByTestId('place-name').props.className).toContain('dark:text-text-header-dark');

    expect(getByTestId('place-type').props.className).toContain('font-work-medium');
    ...
    expect(getByTestId('place-coordinates').props.className).toContain('text-xs');
