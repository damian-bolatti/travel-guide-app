...
describe('CityCard', () => {
  ...
  describe('render', () => {
    ...
    it('aplica correctamente las clases Tailwind', () => {
      ...
      expect(getByTestId('city-card').props.className).toContain('bg-card-background');
      expect(getByTestId('city-card').props.className).toContain('dark:bg-card-background-dark');
      ...
      expect(getByTestId('city-name').props.className).toContain('font-work-bold');
      expect(getByTestId('city-name').props.className).toContain('dark:text-text-header-dark');

      expect(getByTestId('city-native-name').props.className).toContain('text-xl');
      expect(getByTestId('city-native-name').props.className).toContain('italic');
      expect(getByTestId('city-native-name').props.className).toContain('dark:text-text-dark');

      expect(getByTestId('city-currency').props.className).toContain('font-work-light');
      expect(getByTestId('city-currency').props.className).toContain('text-text');

      expect(getByTestId('city-language').props.className).toContain('dark:text-text-dark');
    });
